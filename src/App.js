...
class App extends React.Component {
    ...
    render() {
        ...
        return (
            <Layout
                style={{ minHeight: '100.1vh', background: 'rgb(23,24,25)' }}
            >
                <Header />
                <Content
                    style={{ alignSelf: 'center', width: '80%', marginTop: 25 }}
                >
                        ...
                        <Col xs={24} sm={24} md={24} lg={24} xl={18}>
                            ...
                            >
                                ...
                                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                                    ...
                                    >
                                        Look up any Forsage BUSD member account
                                        in preview mode. Enter ID or BUSD
                                        address to preview or click Demo to view
                                        a random account.
                                    </Typography.Paragraph>
                                </Col>
                            </Row>
